...
export function Header({ langueBR, langueEn }: any) {
  ...
  function menuSm() {
    return (
      <Sheet>
        ...
        <SheetContent className="bg-zinc-950 border-0" side={'right'}>
  ...
  return (
    <header className="h-24 w-full flex justify-between lg:justify-evenly items-center font-semibold text-zinc-100">
      ...
      <div className="w-1/2 h-full hidden md:flex justify-evenly items-center">
        {switchLang()}
        {itensMenu(
          'border-b-2 border-transparent hover:border-b-2 hover:border-zinc-100',
        )}
